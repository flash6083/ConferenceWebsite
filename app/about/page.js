    ...
    return (
        <div className={styles.about}>
            <div className={styles.head}>
                <h1>Discover the Future of Industry 6.0: International Conference on Intelligent and Smart Innovation (CISII-24) - March 01-02, 2024, Kolkata, India</h1>
            ...
            <p className={styles.content}>
                <em>International Conference on Intelligent and Smart Innovation for Industry 6.0 (CISII - 24), is going to be organized on 01 and 02 March 2024 at the Techno Main Salt Lake in Kolkata, India.
                    ...
                    We cordially invite all interested participants to join us at CISII - 24, where together, we can chart a course towards a smarter and more innovative future for Industry 6.0. Mark your calendars for 01 and 02 March 2024, and be part of this extraordinary event that promises to shape the future of technology and industry. We look forward to welcoming you to Kolkata, India, for an intellectually stimulating and unforgettable experience.
                </em>
            </p>
        </div>
    )
